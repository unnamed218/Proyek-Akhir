	...
	<html>
	<head>
		<title>Laporan Pembayaran Beban Variabel</title>
	</head>
	<body>
		<?php  $namabulan = array(
      '0' => 'December',
 ...
 <div class="x_title">
    <h3 class="panel-title"><b>Daftar Pembayaran Beban Variabel</b></h3>
  	 ...
  	 <div class="x_content">
  	 	<div class="row">
  	 		<div class="col-sm-6">
		<form class = 'form-inline' method = "POST" class = "form-inline" action = "<?php echo site_url().'/c_keuangan/lap_pembyv';?>">
...
<?php if(isset($bulan, $tahun)):?>
	...
	<?php endif ?>
  	 ...
  	 <div style="font-size: 20px">Laporan Pembayaran Beban Variabel</div>
